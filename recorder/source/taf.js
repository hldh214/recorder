...
Taf.DataHelp = {
    ...
    Taf.BinBuffer.prototype.writeInt8 = function (t) {
        // console.log('BinBuffer.prototype.writeInt8, t, ', t);
        this.allocate(1),
    ...
    Taf.BinBuffer.prototype.writeUInt8 = function (t) {
        // console.log('BinBuffer.prototype.writeUInt8, t, ', t);
        this.allocate(1),
    ...
    Taf.BinBuffer.prototype.writeInt32 = function (t) {
        // console.log('BinBuffer.prototype.writeInt32, t', t)
        this.allocate(4),
    ...
    Taf.BinBuffer.prototype.writeInt64 = function (t) {
        // console.log('BinBuffer.prototype.writeInt64, t', t)
        this.allocate(8),
    ...
    Taf.JceOutputStream.prototype.writeTo = function (t, e) {
        // console.log('JceOutputStream.prototype.writeTo, t, e', t, e)
    ...
    Taf.JceOutputStream.prototype.writeInt16 = function (t, e) {
        // console.log('writeInt16, t, e', t, e)
    ...
    Taf.JceOutputStream.prototype.writeInt32 = function (t, e) {
        // console.log('writeInt32, t, e', t, e)
    ...
    Taf.JceOutputStream.prototype.writeInt64 = function (t, e) {
        // console.log('writeInt64, t, e', t, e)
...
var get_living_info_rsp = function (resultBuffer) {
    let inputStream = new Taf.JceInputStream(resultBuffer.buffer)
    let cmd = new HUYA.WebSocketCommand;
    cmd.readFrom(inputStream)

    var u = new Taf.Wup;
    u.decode(cmd.vData.buffer);
    var p = TafMx.WupMapping[u.sFuncName];
    var l = new p;
    res = u.readStruct('tRsp', l, p);

    return res;
}

var get_living_info_req = function (lSubSid) {
    let living_info = new HUYA.GetLivingInfoReq;
    living_info.tId = new HUYA.UserId;
    living_info.tId.lUid = 0;
    living_info.tId.sGuid = "";
    living_info.tId.sToken = "";
    living_info.tId.sHuYaUA = "webh5&2002291515&websocket";
    living_info.tId.sCookie = "";
    living_info.tId.iTokenType = 0;
    living_info.tId.sDeviceInfo = "Chrome";
    living_info.iRoomId = 0;
    living_info.lPresenterUid = 0;
    living_info.lSubSid = lSubSid;
    living_info.lTopSid = 0;
    living_info.sPassword = "";
    living_info.sTraceSource = null;

    var a = new Taf.Wup;

    a.setServant('liveui');
    a.setFunc('getLivingInfo');
    a.writeStruct("tReq", living_info);
    a.setRequestId(-1);
...
switch (myArgs[0]) {
    case 'GetLivingInfoReq':
        console.log(JSON.stringify(Array.from(get_living_info_req(myArgs[1]))));
        break;
